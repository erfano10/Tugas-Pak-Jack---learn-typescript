...
function showBonusStatus(
    ...
    if (performanceScore >= 85) {
        console.log(`${employeeName} - Perfomance Score: ${performanceScore} -> Bonus Approved`)
    } else {
        console.log(`${employeeName} - Perfomance Score: ${performanceScore} -> Bonus not Aproved`)
    }
}

showBonusStatus("John Cena", 92)
showBonusStatus("Undertaker", 76)
showBonusStatus("ReyMasterio", 88)